...
int main(int argc, char **argv) {
    ...
    parser.addOption("create", 'c').setHelp("create an index in the directory");
    parser.addOption("cleanup", 'n').setHelp("cleanup the index directory after importing the data");
    parser.addOption("optimize", 'o').setHelp("optimize the index after importing the data");
