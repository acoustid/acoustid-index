...
FSInputStream::FSInputStream(const FSFileSharedPtr &file) : m_file(file) {}

FSInputStream::~FSInputStream() {}

int FSInputStream::fileDescriptor() const { return m_file->fileDescriptor(); }

const FSFileSharedPtr &FSInputStream::file() const { return m_file; }
