...
BufferedInputStream::BufferedInputStream(size_t bufferSize) : m_bufferSize(bufferSize), m_buffer(0), m_start(0), m_position(0), m_length(0) {}

BufferedInputStream::~BufferedInputStream() {}

size_t BufferedInputStream::bufferSize() { return m_bufferSize; }
...
size_t BufferedInputStream::position() { return m_start + m_position; }
