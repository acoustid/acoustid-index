...
BufferedOutputStream::BufferedOutputStream(size_t bufferSize) : m_bufferSize(bufferSize), m_start(0), m_position(0) {
    m_buffer.reset(new uint8_t[m_bufferSize]);
}

BufferedOutputStream::~BufferedOutputStream() {}

size_t BufferedOutputStream::bufferSize() { return m_bufferSize; }
...
void BufferedOutputStream::flush() { flushBuffer(); }

size_t BufferedOutputStream::position() { return m_start + m_position; }
